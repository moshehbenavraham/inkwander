...
const Creativity = () => {
  ...
  useSEO({
    ...
    description:
      "Unlock your creative potential. Practices, mindsets, and tools that help creatives stay inspired, overcome blocks, and build sustainable creative lives.",
    path: "/creativity",
    jsonLd: jsonLd.collectionPage({
      name: "Creativity & Expression",
      description:
        "Practices and insights that nurture your artistic journey and creative practice.",
      path: "/creativity",
      itemCount: creativityArticles.length,
    }),
  });
  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main id="main" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Articles Grid */}
        <section aria-label="Creativity articles">
