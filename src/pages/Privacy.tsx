...
import { CONTACT_LOCATION } from "@/lib/site";

const Privacy = () => {
  useSEO({
    title: "Privacy Policy",
    description:
      "How Perspective collects, uses, and protects your personal information. Our commitment to transparent data practices.",
    path: "/privacy",
  });
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-4">
              Email:{" "}
              <a
                href="mailto:privacy@perspective.blog"
                className="hover:text-accent transition-colors"
              >
                privacy@perspective.blog
              </a>
              {CONTACT_LOCATION && (
                <>
                  <br />
